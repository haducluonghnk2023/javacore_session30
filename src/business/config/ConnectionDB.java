    ...
    public  static void closeConnection(Connection conn, CallableStatement callSt){
        if (conn != null) {
            try {
                ...
                System.out.println("Có lỗi trong quá trình đóng kết nối đến CSDL " + e.getMessage());
            }
        }
        if (callSt != null) {
            try {
                ...
                System.out.println("Có lỗi trong quá trình đóng CallableStatement " + e.getMessage());
            }
        }
    }
}
